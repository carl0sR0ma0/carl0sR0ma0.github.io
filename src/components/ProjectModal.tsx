      ...
      {project && (
        ...
        >
          <motion.div
            ...
            className="relative my-8 w-full max-w-3xl overflow-hidden rounded-2xl border border-white/10 bg-bg-primary"
          >
            {/* Header gradient */}
            <div className="h-1 w-full bg-gradient-to-r from-accent-green to-accent-purple" />

            {/* Close button */}
            <button
              onClick={onClose}
              className="absolute right-4 top-5 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-white/5 text-text-secondary transition-colors hover:bg-white/10 hover:text-text-primary"
              aria-label="Fechar"
            >
            ...
            <div className="p-6 md:p-8">
              ...
              {availableScreenshots.length === 0 && (
                <div className="mb-6 flex aspect-video items-center justify-center rounded-xl border border-dashed border-white/10 bg-bg-card">
                  <div className="text-center">
                    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" className="mx-auto mb-2 text-text-secondary/30">
                    ...
                    <p className="text-sm text-text-secondary/40">Screenshots em breve</p>
                  </div>
                </div>
              )}
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.techs.map((tech) => (
                    <span
                      key={tech}
                      className="rounded-lg border border-white/10 bg-bg-card px-3 py-1.5 font-mono text-xs text-text-primary"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-accent-green to-accent-purple px-6 py-2.5 text-sm font-semibold text-bg-primary transition-transform hover:scale-105"
                >
                ...
                <button
                  onClick={onClose}
                  className="rounded-lg border border-white/10 px-6 py-2.5 text-sm font-medium text-text-secondary transition-colors hover:border-white/20 hover:text-text-primary"
                >
                  Fechar
                </button>
              </div>
